...
(define-struct myability (image time pos next))
; Fiecare funcție returneaza o componenta a unei abilități.
(define (get-ability-image ability) myability-image ability)
(define (get-ability-time  ability) myability-time ability)
(define (get-ability-pos   ability) myability-pos ability)
(define (get-ability-next  ability) myability-next ability)
